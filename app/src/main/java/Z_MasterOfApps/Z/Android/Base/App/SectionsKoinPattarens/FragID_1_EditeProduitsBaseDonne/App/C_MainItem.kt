...
import Z_MasterOfApps.Z.Android.Base.App.SectionsKoinPattarens.FragID_1_EditeProduitsBaseDonne.App.Z.Learn.Product
...
fun C_MainItem(
    ...
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable(onClick = {
                coordinator.onProductClick(product.id)
            }),
