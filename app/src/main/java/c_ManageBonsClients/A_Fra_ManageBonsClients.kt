                            ...
                            clientsId?.let { id ->
                                ...
                                try {
                                    ...
                                    val texteImprimable = StringBuilder().apply {
                                        ...
                                        append("<SMALL><LEFT>Client:<MEDIUM1>  $clientsName")
                                        append("<BR>")
                                        append("<SMALL><CENTER>Date : ($dayOfWeek)${formattedDateTime}")
                                        append("<BR>")
                                        append("<MEDIUM1><CENTER>($dayOfWeek)${formattedDateTime}")
                                        append("<BR>")
                                        append("<MEDIUM1><LEFT>Versement : ")
                                        append("<BIG><CENTER>$paymentAmount Da")
                                        append("<BR>")
                                        append("<MEDIUM1><LEFT>Totale Rest Du Credit = $newCredit Da")
                                        append("<BR>")
                                        append("<BIG><CENTER>$newCredit Da")
                                        append("<LEFT><NORMAL><MEDIUM1>=====================<BR>")
                                        append("<BR><BR><BR>>")
                                    }.toString()
